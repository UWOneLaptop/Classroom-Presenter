...
class NavToolBar(gtk.Toolbar):
    ...
    def set_lock_button(self, widget, is_locked):
        sharing = self.__arbiter.get_sharing_mode()
...
class InkToolBar(gtk.Toolbar):
    ...
    def __init__(self, arbiter):
        ...
        self.__erase.show()
        self.__erase.set_tooltip(_('Eraser'))
        self.__erase.connect('clicked', self.erase_btn_clicked)

        # Erase 
        self.__erase_all = ToolButton('tool-eraser')
        self.insert(self.__erase_all, -1)
        self.__erase_all.show()
        self.__erase_all.set_tooltip(_('Clear All Ink'))
        self.__erase_all.connect('clicked', self.erase_all_btn_clicked)
    ...
    def erase_all_btn_clicked(self, widget):
        self.__arbiter.do_clear_ink()
    
    def erase_btn_clicked(self, widget):
        self.__arbiter.do_set_eraser()
